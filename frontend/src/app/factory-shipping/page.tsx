...
import { FACTORY_SHIPPING_COLUMNS } from '@/types';
...
function PageContent() {
  ...
  const { user, setSelectedOrder } = useStore();
  ...
  // If shipping columns not yet defined, show all columns as fallback
  const columnKeys = FACTORY_SHIPPING_COLUMNS.length > 0 ? FACTORY_SHIPPING_COLUMNS : undefined;
    ...
    <AppShell title="Factory Shipping">
      <div className="flex flex-col overflow-hidden" style={{ height: 'calc(100vh - 116px)' }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Factory Shipping</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => router.push('/factory-shipping-v2')}
